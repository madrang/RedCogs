...
SYSTEM_PROMPT = (
    ...
    "- A harness block starts with `[harness]` and ends with `[/harness]`. It arrives as a **user** message.\n"
    "  When a harness block asks to condense the conversation, answer with a summary of the conversation so far.\n"
    "\n"
    "Memory rules:\n"
